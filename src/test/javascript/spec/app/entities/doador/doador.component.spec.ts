...
import { DoadorComponent } from 'app/entities/doador/doador.component';
import { DoadorService } from 'app/entities/doador/doador.service';
import { Doador } from 'app/shared/model/doador.model';

describe('Component Tests', () => {
  describe('Doador Management Component', () => {
    let comp: DoadorComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DoadorComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(DoadorComponent);
      comp = fixture.componentInstance;
      service = fixture.debugElement.injector.get(DoadorService);
    });
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.doadors && comp.doadors[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
